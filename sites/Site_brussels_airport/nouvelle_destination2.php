...
<html>
    ...
    <body>
        <div id="bloc_page">
            ...
            <p>
            <?php
                $req = $bdd->prepare('INSERT INTO destination(city,flight_time,distance) VALUES(?,?,?)');
                $req->execute(array($_POST['city'],$_POST['flight_time'],$_POST['distance']));
                header('Location: nouvelle_destination.php');
            ?>
