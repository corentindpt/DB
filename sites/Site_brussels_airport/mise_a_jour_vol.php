...
<html>
    ...
    <body>
        ...
        <form action="mise_a_jour_vol2.php" method="post">
        <p>
        <label for="id_flight">numéro de vol</label> : <input type="number" name="id_flight" id="id_flight" /><br />
        <label for="plane_idPlane">Numéro de l'avion</label> : <input type="number" name="plane_idPlane" id="plane_idPlane" /><br />
        <label for="destination_idDestination">Destination </label> : <input type="number" name="destination_idDestination" id="destination_idDestination" /><br />
